...
В докере запустил сервер мастера. Создал пользователя и настроил мастера. Чтение бинарного файла mysql-bin.000006 slave должен начать со строки 660.

![Снимок96](https://github.com/Makarov-Denis/12_06-Replic-and-scaling_1/assets/148921246/8b82f340-29b6-4062-b19f-df4bd26643cf)
